...
**THESIS:** quiz1v1 is not a dashboard with quiz features bolted on — it's a versus-screen: every surface is staged as a match (select your mode/topic, face an opponent or the clock, see the verdict), refusing the generic dark-SaaS-dashboard-with-cards arrangement the category defaults to.
